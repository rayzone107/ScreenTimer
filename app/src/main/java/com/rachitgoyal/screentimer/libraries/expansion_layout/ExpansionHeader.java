package com.rachitgoyal.screentimer.libraries.expansion_layout;
...
public class ExpansionHeader extends FrameLayout {
    ...
    private int headerRotationExpanded = 315;
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        if (attrs != null) {
            ...
            if (a != null) {
                setHeaderRotationExpanded(a.getInt(R.styleable.ExpansionHeader_expansion_headerIndicatorRotationExpanded,
                        headerRotationExpanded));
                setHeaderRotationCollapsed(a.getInt(R.styleable.ExpansionHeader_expansion_headerIndicatorRotationCollapsed,
                        headerRotationCollapsed));
                setHeaderIndicatorId(
                        a.getResourceId(R.styleable.ExpansionHeader_expansion_headerIndicator, headerIndicatorId));
